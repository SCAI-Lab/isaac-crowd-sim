# Move this file to exts/omni.isaac.core/omni/isaac/core/utils/nucleus.py
...
def get_isaac_asset_root_path() -> typing.Union[str, None]:
    ...
    if isaac_asset_root:
        ...
        if result:
            ...
            if result is Result.OK:
                carb.log_info(
                    "Isaac Sim assets version {} found at {}".format(ver_asset, isaac_asset_root)
                )
    ...
    if cloud_assetsURL:
        ...
        if result:
            ...
            if result is Result.OK:
                carb.log_info(
                    "Isaac Sim assets version {} found at {}".format(ver_asset, cloud_assetsURL)
                )
